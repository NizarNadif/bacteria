 ...
 */
public class TontinoMappato extends batteri.Batterio implements Cloneable {
    ...
    public TontinoMappato(int x, int y, Color c, Food f) {
        super( x, y, c, f );
        if ( !this.state ) {
    ...
    public batteri.Batterio Clona() {
        try {
            return (TontinoMappato) this.clone();
        } catch (CloneNotSupportedException ex) {
            Logger.getLogger( TontinoMappato.class.getName() ).log( Level.SEVERE, null, ex );
        }
        return null;
    }
